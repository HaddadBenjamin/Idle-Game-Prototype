...
public class EventManagerParamsInt<EnumerationType> where EnumerationType : struct, IConvertible
{
    public delegate void Delegate(int paramA);
    ...
    /// </summary>
    /// <param name="enumeration"></param>
    public void CallEvent(EnumerationType enumeration, int paramA)
    {
